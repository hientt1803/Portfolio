...
const ProjectSection = () => {
    ...
    return (
        <section className="section" id="projects">
            <p className="display-1 fw-bold mb-5">Imagination Trumps Knowledge!</p>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        <small className="text-body-secondary">
                                            ...
                                            (Earpod, Headphone,...). This project use ReactJS, Bootstrap 5
                                            and RestFullAPI with Spring Boot and Database by SQL Server.
                                        </small>
                                    </p>
                    ...
                    <div class="card text-start p-3" style={cardStyle}>
                        ...
                        <div class="card-body">
                            ...
                            <div className="d-flex justify-content-between mt-3">
                                <a href={"https://github.com/hientt1803/Java-4-ASM"} className="text-dark text-decoration-none">Github </a>
                                <a href={"#"} className="btn btn-dark fw-semibold">
                                    Comming soon{" "}
                                    <i className="fa-regular fa-share-from-square"></i>
                                </a>
                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="card text-start p-3" style={cardStyle}>
                        ...
                        <div class="card-body">
                            ...
                            <div className="d-flex justify-content-between mt-3">
                                <a href={"https://github.com/hientt1803/Portfolio"} className="text-dark text-decoration-none">Github </a>
                                <a href={"#"} className="btn btn-dark fw-semibold">
                                    Comming soon{" "}
                                    <i className="fa-regular fa-share-from-square"></i>
                                </a>
